jQuery("#simulation")
  .on("click", ".s-36eb48ac-8f97-4946-9748-32b1c26b905f .click", function(event, data) {
  ...
  .on("pageload", ".s-36eb48ac-8f97-4946-9748-32b1c26b905f .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
